  ...
  return (
    ...
    >
      {items.map((item) => {
        ...
        const content = (
          <>
            {isActive ? <motion.span layoutId="nav-pill-active" className="chroma-pill-active" /> : null}
            <span className="chroma-pill-icon" aria-hidden>
              {item.icon}
            </span>
            <motion.span
              className="chroma-pill-label"
        ...
        const className = `chroma-pill-item ${isActive ? "is-active" : ""}`;
