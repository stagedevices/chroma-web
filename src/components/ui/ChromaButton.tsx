...
type ChromaButtonVariant = "primary" | "secondary" | "ghost" | "icon";
type ChromaButtonSize = "sm" | "md" | "lg";
...
type ChromaButtonOwnProps = {
  variant?: ChromaButtonVariant;
  size?: ChromaButtonSize;
  motion?: boolean;
  disabled?: boolean;
  className?: string;
};

type ChromaButtonProps<T extends ElementType> = PolymorphicComponentProps<T, ChromaButtonOwnProps>;

type ChromaButtonComponent = <T extends ElementType = "button">(
  props: ChromaButtonProps<T> & { ref?: PolymorphicRef<T> },
) => JSX.Element | null;

const ChromaButton = forwardRef(
  <T extends ElementType = "button">(
    ...
    const handleAnimationEnd = useCallback(
      (event: AnimationEvent<HTMLElement>) => {
        if (event.animationName === "chroma-btn-sweep") {
